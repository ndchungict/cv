...
- [x] 1. Scaffold Jekyll project structure and configuration
...
- [x] 2. Create base layouts
  - [x] 2.1 Implement `_layouts/default.html`
  ...
  - [x] 2.2 Implement `_layouts/home.html`
...
- [x] 3. Create HTML includes (partials)
  - [x] 3.1 Implement `_includes/head.html`
    - Add `<meta charset>`, `<meta viewport>`, `<title>`, and CSS `<link>` tags
    - _Requirements: 2.3_

  - [x] 3.2 Implement `_includes/header.html`
...
- [x] 5. Implement CV section includes
  - [x] 5.1 Implement `_includes/about.html`
  ...
  - [x] 5.4 Implement `_includes/experience.html`
  ...
  - [x] 5.8 Implement `_includes/education.html`
...
- [x] 6. Checkpoint — Verify Jekyll build
...
- [x] 8. Implement JavaScript module (`assets/js/main.js`)
  - [x] 8.1 Inject i18n data and implement language switcher
  ...
  - [x] 8.6 Implement PDF export (`exportPDF` and `getExportFilename`)
...
- [x] 9. Set up JavaScript testing framework
...
- [x] 10. Checkpoint — Full build and test pass
